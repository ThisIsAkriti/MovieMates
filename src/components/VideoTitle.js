...
const VideoTitle = ({title , overview , movieId}) => {
  ...
  return (
    <div className=' pt-[40%] sm:pt-[24%] xl:pt-[14%] lg:pt-[18%] px-12 absolute text-white w-screen aspect-video md:mt-0 -mt-44 '>
      ...
      <div className='flex '>
        ...
        className='flex items-center bg-gray-100 font-semibold text-black xl:px-4 md:px-3 md:py-2 px-2 py-1 border-purple-600 border rounded-lg mr-4 hover:bg-purple-400 hover:bg-opacity-80 hover:shadow-md hover:shadow-purple-800 hover:border-none md:text-md text-xs'>
        ...
        className='flex items-center bg-purple-900 font-semibold text-white xl:px-4 md:px-2 md:py-2 px-2 py-1
          border-purple-900   
